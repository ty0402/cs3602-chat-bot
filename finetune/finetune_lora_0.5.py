...
sys.argv = [
    ...
    "--model_name_or_path", "/hpc_stor03/sjtu_home/ye.tao/workspace/LLM/qwen2.5_0.5b",  # 模型路径或标识符
    "--dataset_path", "/hpc_stor03/sjtu_home/ye.tao/workspace/LLM/Alpaca Cleaned",  # 数据集名称
    "--output_dir", "/hpc_stor03/sjtu_home/ye.tao/workspace/LLM/output/qwen-0.5B/l=1024_bs=1",  # 检查点保存路径
