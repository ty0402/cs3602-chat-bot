...
sys.argv = [
    ...
    "--model_name_or_path", "autodl-tmp/qwen2.5",  # 模型路径或标识符
    "--dataset_path", "Alpaca Cleaned",  # 数据集名称
    "--output_dir", "autodl-tmp/working/lora_0.5b",  # 检查点保存路径
